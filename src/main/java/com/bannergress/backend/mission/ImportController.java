...
import com.bannergress.backend.mission.creator.CreatorGetMissionForProfile;
import com.bannergress.backend.mission.creator.CreatorGetMissionsList;
import com.bannergress.backend.mission.creator.CreatorImportService;
import com.bannergress.backend.mission.intel.IntelImportService;
import com.bannergress.backend.mission.intel.IntelMissionDetails;
...
public class ImportController {
    ...
    public Map<String, MissionStatusDto> importMissionSummaries(@RequestBody List<com.bannergress.backend.mission.intel.IntelMissionSummary> summaries) {
